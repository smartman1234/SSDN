...
export default function GeneralEnquery() {
  ...
  const apiCall = async (activity) => {
    try {
      let response = await enquiry.generalenquiry(activity);
      if (response) {
        const arr = response.data.map((v) => {
          return { ...v, assessment: v.assessment?.name };
        });
        setEnqueryList(arr);
  ...
  return (
    <div className="page-body">
      <Breadcrumb heading="Web Enquiry " />
      <div className="container-fluid support-ticket">
        <div className="row">
          <div className="col-sm-12">
            <div className="card">
              <div className="card-header">
                <h5>Web Enquiry List</h5>
              </div>
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="card o-hidden border-0">
                      ...
                      >
                        {" "}
                        <CsvLink data={enqueryList} fileName=" Enquiry List">
