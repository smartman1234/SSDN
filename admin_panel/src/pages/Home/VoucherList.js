                                    ...
                                    <div className="bg-primary b-r-4 card-body">
                                        <div className="media static-top-widget">
                                            ...
                                            <div className="media-body">
                                                <span className="m-0">Total Voucher</span>
                                ...
                                <div className="card o-hidden border-0">
                                    <div className="bg-secondary b-r-4 card-body">
                                        <div className="media static-top-widget">
                                            ...
                                            <div className="media-body">
                                                <span className="m-0">Total Sold Voucher</span>
                                ...
                                <div className="card o-hidden border-0">
                                    <div className="bg-primary b-r-4 card-body">
                                        <div className="media static-top-widget">
                                            ...
                                            <div className="media-body">
                                                <span className="m-0">Total Available Voucher</span>
                                ...
                                <div className="card o-hidden border-0">
                                    <div className="bg-primary b-r-4 card-body">
                                        <div className="media static-top-widget">
                                            ...
                                            <div className="media-body">
                                                <span className="m-0">Need to verify</span>
                                ...
                                <div className="card o-hidden border-0">
                                    <div className="bg-primary b-r-4 card-body">
                                        <div className="media static-top-widget">
                                            ...
                                            <div className="media-body">
                                                <span className="m-0">Expire in next 60 days</span>
                                                <h4 className="mb-0 counter">4531</h4>
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width="24"
                                ...
                                <div className="card o-hidden border-0">
                                    <div className="bg-primary b-r-4 card-body">
                                        <div className="media static-top-widget">
                                            ...
                                            <div className="media-body">
                                                <span className="m-0">Expire in next 30 days</span>
                                                <h4 className="mb-0 counter">4531</h4>
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width="24"
