...
const ELearningCourseList = () => {
  ...
  const name = (
    <Link to="/e-learning-create-course" className="btn btn-primary">
                    ...
                    <div className="col-lg-12">
                      <div className="card o-hidden border-0">
                        ...
                        >
                                  ...
                                  <tr key={i}>
                                    ...
                                    <td className="text-center">
                                      {rolePermission.is_edit == 1 && (
                                        <Link
                                          to={`/e-learning-edit-course/${v.id}`}
                                    ...
                                    <td className="text-center">
                                      <Link
                                        to={`/create-e-learning-course-video/${v.id}`}
                                        className="btn btn-outline-primary btn-sm me-2"
                                        title="Edit Course Category"
                                      >
                                        Add
                          ...
                          >
                            Showing {offset + 1} to{" "}
                            {offset + courseList?.length} of {totalCount}{" "}
                            entries
                          </div>
                          <div
...
export default ELearningCourseList;
