...
const ClientList = () => {
  ...
  const getClientList = async () => {
    ...
    fetch(`${url}client/get-our-client-list`, requestOptions)
  ...
  const ShowAlert = async (e, id) => {
    Swal.fire({
      ...
      if (result !== null) {
        ...
        fetch(`${url}client/delete-our-client/${id}`, requestOptions)
          .then((response) => response.json())
          .then((data) => {
  ...
  return (
    <>
      <div className="page-body">
        <Breadcrumb heading="Client" add={rolePermission.is_add == 1 && name} />
