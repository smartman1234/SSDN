...
function BranchLocation() {
    ...
    const name = (
        <Link to="/branch-location-add" className="btn btn-primary">
        <i className="fa-solid fa-plus me-2"></i>Add Branch
        </Link>
    );
    return (
        <div className="page-body">
            <Breadcrumb heading="Branch Location"  add={rolePermission.is_add == 1 && name}/>
