...
function List() {
  ...
  const name = (
    <Link to="/course-list-add" className="btn btn-primary">
      <i className="fa-solid fa-plus me-2"></i>Add Course
    </Link>
  );
  return (
    <div className="page-body">
      <Breadcrumb heading="Course" add={rolePermission.is_add == 1 && name} />
