...
function List() {
  ...
  const name = (
    <Link to="/voucher-list-add" className="btn btn-primary">
      <i className="fa-solid fa-plus me-2"></i>Add Voucher
    </Link>
  );
  return (
    <div className="page-body">
      <Breadcrumb heading="Vouchers" add={rolePermission.is_add == 1 && name} />
