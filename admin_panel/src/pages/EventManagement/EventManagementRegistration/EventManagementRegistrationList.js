...
export default function EventManagementRegistrationList() {
  ...
  const apiCall = async (activity) => {
    try {
      let response = await serve.eventregistrationlist(activity);
      if (response) {
  ...
  return (
    <>
      ...
      <div className="page-body">
        <Breadcrumb heading="Event Management Registration" />
        <div className="container-fluid support-ticket">
          <div className="row">
            <div className="col-sm-12">
              <div className="card">
                <div className="card-header">
                  <h5>Event Management Registration List</h5>
                </div>
