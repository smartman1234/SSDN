...
export default function BuyTogetherOtherCourse2Assessment({
  buytogether,
  currency,
  ...
  return (
    <>
      {" "}
      {buytogether?.other_course_2_type === "assessment" && (
            ...
            <div className="inner" style={{ height: "280px" }}>
              <div className="thumbnail">
                <Link to="#">
                   <LazyLoadImage
                    className="w-100"
                    src={buytogether?.other_course_2?.image}
                    alt={buytogether?.other_course_2?.image_alt_tag}
                    height="100%"
                    width="100%"
                  />
                </Link>
