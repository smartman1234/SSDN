...
export default function BuyTogetherCourse1({
  buytogether,
  currency,
  ...
  return (
    <>
      {" "}
      {buytogether?.other_course_1_type === "course" && (
        <div className="col-md-4 position-relative">
          <div className="edu-card card-type-3 radius-small">
            <div className="inner" style={{ height: "280px" }}>
              <div className="thumbnail">
                <Link to="#">
                  {buytogether?.other_course_1?.media_type === "video" ? (
                     <LazyLoadImage
                      className="w-100"
                      src={buytogether?.other_course_1?.thumb_image}
                      alt="Course Thumb"
                      height="100%"
                      width="100%"
                    />
                     ...
                     <LazyLoadImage
                      className="w-100"
                      src={buytogether?.other_course_1?.media}
                      alt="Course Thumb"
                      height="100%"
                      width="100%"
                    />
